// AutoStan: regression_1d iter 7
// Contamination mixture + Normal clean + cubic+sin(x) mean + linear log-sigma.
// iter 5 NLPD=1.1244 best (cubic+mixture+Normal); iter 6=1.1520 (added t-clean+sin, worse).
// Disentangling: test sin(x) addition alone, keeping Normal clean component from iter 5.
// If sin(x) adds value, it will improve. If not, we need a different direction.
