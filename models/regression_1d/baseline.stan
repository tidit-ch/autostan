// AutoStan: regression_1d baseline
// Iteration 1: Simple linear regression with normal errors.
// Baseline to establish NLPD before adding nonlinearity, robust likelihood, etc.
