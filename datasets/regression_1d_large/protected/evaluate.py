...
Uses 30x more MCMC iterations than the small version for lower Monte Carlo noise.
"""
...
def main():
    ...
    # Sample: 4 chains x 30000 iterations (30x more for low MC noise)
    print("Sampling: 4 chains x 30000 iterations (30000 warmup)...")
